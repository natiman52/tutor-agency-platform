      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex-shrink-0">
            <Link to="/" className="text-2xl font-bold text-primary">Hytor</Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            {user ? (
              ...
              <>
                <Link to="/login" className="text-sm font-medium text-neutral-600 hover:text-primary transition-colors">Log in</Link>
                <Link 
                  to="/register" 
          ...
          <div className="md:hidden flex items-center">
            {user ? <ProfileDropdown /> : (
                 <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="text-neutral-600 hover:text-primary focus:outline-none">
        ...
        <div className="md:hidden bg-white py-4">
          <div className="container mx-auto px-4 space-y-4">
            ...
            <div className="border-t pt-4 space-y-2">
                <Link to="/login" className="block text-sm font-medium text-neutral-600 hover:text-primary transition-colors">Log in</Link>
                <Link 
                  to="/register" 
